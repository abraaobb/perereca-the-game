...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (player2, car) {
    // Perde uma vida ao colidir com carro
    info.changeLifeBy(-1)
    // Reseta a posição do sapo
    player2.setPosition(80, 110)
})
// Sapo começa com 3 vidas
// FUNÇÃO PARA CRIAR CARROS
function spawnCars () {
    // 0 para esquerda->direita, 1 para direita->esquerda
    direction = randint(0, 1)
    // Configuração para cada direção
    if (direction == 0) {
        car = sprites.create(img`
            ...
            `, SpriteKind.Enemy)
        // Começa na esquerda
        car.setPosition(0, randint(20, 100))
        // Movimenta-se para a direita
        car.setVelocity(randint(70, 120), 0)
    } else {
        car = sprites.create(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . 2 2 2 2 2 2 2 2 . . 
            ...
            `, SpriteKind.Enemy)
        // Começa na direita
        car.setPosition(160, randint(20, 100))
        // Movimenta-se para a esquerda
        car.setVelocity(0 - randint(70, 120), 0)
    }
    // Remove o carro ao sair da tela
...
// Cria o sapo
let frog = sprites.create(assets.image`frog`, SpriteKind.Player)
// Posiciona o sapo na parte inferior da tela
...
game.onUpdate(function () {
    if (frog.y < 10) {
        ...
        // Reseta o sapo para reiniciar o desafio
        frog.setPosition(80, 110)
    }
})
...
game.onUpdateInterval(5000, function () {
    ...
    // Gradualmente aumenta a velocidade dos carros
    speedIncrease = randint(10, 20)
    game.onUpdateInterval(1000, function () {
        spawnCars()
    })
})
// CRIANDO CARROS PERIODICAMENTE
